    ...
    public partial class Form1 : Form
    {
        ...
        private void button8_Click(object sender, EventArgs e)
        {
            ...
            switch (format)
            {
                case Format.f16bit:
                case Format.f16dither:
                    var result = MessageBox.Show("Do you want to swap bytes in the generated data? Useful for LCD displays connected via SPI.","Swap bytes ????", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
